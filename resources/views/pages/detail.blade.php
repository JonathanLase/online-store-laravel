        ...
        <section class="store-gallery" id="gallery">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="row">
                            <div class="col-3 col-lg-12 mt-2 mt-lg-8" v-for="(photo, index) in photos"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="owner">By Jonathan Lase <span class="text-muted">Store Owner</span></div>
                            <div class="price">$1,409</div>
                        </div>
                        <div class="col-lg-2" data-aos="zoom-in">
                            <a href="/cart" class="btn btn-success px-4 text-white btn-block mb-3">Add to Cart</a>
                        </div>
                    </div>
                </div>
            </section>
